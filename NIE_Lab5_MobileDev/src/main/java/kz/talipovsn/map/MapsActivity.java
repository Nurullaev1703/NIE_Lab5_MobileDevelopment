...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    static final LatLng startMarker = new LatLng(52.290626257877754, 76.97519328424525); // Начальный маркер
    static final LatLng marker1 = new LatLng(52.293322145134574, 76.97292320424613); // Маркер Альпенхоф
    static final LatLng marker2 = new LatLng(52.29315336392347, 76.9749893470727); // Маркер кинотеатр Айманова
    static final LatLng marker4 = new LatLng(52.291511639081875, 76.97506122358594); // Маркер Microfon
    static final LatLng marker3 = new LatLng(52.290819170948005, 76.97143839780784); // Маркер 5 школа
    static final LatLng marker5 = new LatLng(52.29168908230741, 76.96956330226605); // Маркер парк Афганцев
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(marker1).title(getString(R.string.marker1_title)).icon(
                BitmapDescriptorFactory.fromResource(R.drawable.bv)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker2).title((getString(R.string.marker2_title))).icon(
                BitmapDescriptorFactory.fromResource(R.drawable.wb)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker4).title((getString(R.string.marker4_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.eur)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker5).title((getString(R.string.marker5_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.kuis)).alpha(ALPHA).
